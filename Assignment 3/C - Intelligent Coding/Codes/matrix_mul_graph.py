...
# Load the CSV file
csv_file_path = "matrix_mul.csv"  # Adjust as needed to the correct file path
...
y_lines = data.loc[:, "ijk":"jik"]  # Select all columns from 'ijk' to 'jik'
...
plt.title("Matrix Multiplication Execution Time by Algorithm")
